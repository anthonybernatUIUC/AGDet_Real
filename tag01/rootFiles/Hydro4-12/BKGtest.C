...
//Read Data from TFile
	TFile *input1 = new TFile("TestBKG.root", "read");
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
//Graph the data
	TString Title = "Simulated Background Spectrum Test Hydrogen-1";
	...
	//Draw Legend
	TLegend *leg = new TLegend(0.6, 0.77, 0.85, 0.87);
	leg->SetBorderSize(0);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
//Print the Graph
        TString GraphName = "BackgroundTest_H1_4_12.png";
